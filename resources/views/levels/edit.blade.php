         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="id_level" value="{{ $level->id_level }}" class="form-control" placeholder="ID Level">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Level:</strong>
                    <input type="text "class="form-control" value="{{ $level->nama_level }}" name="nama_level" placeholder="Nama Level">
                </div>
            </div>
